            ...
            <div class="card violationCard">
                <div class="card-body">
                    <div class="violationCardLine">
                        <h3 class="card-title violationCardTitleItem">
                    ...
                    <div class="violationCardLine">
                        ...
                        <h4 class="card-subtitle mb-2 text-muted violationCardTitleItem">
                            {{wcag}}
                        </h4>
                    </div>
                    <div class="violationCardLine">
                    ...
                    <div class="violationCardLine">
                        <h5 class="card-subtitle mb-2 text-muted violationCardTitleItem">
                            Issue Tags: {{#tags}}
